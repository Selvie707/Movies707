...
public class MyDBHelperFavorite extends SQLiteOpenHelper {
    private Context ctx;
    private static final String DATABASE_NAME = "dbMovieFav";
    private static final String TABLE_NAME = "tbFavorite";
    ...
    public MyDBHelperFavorite(@Nullable Context context) {
